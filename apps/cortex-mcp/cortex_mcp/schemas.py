...
class PrepareOwnerStatementInput(BaseModel):
    owner_id: str = Field(default="", description="Consignment Owner ID")
    period: str = Field(default="", description="Statement month, YYYY-MM (amounts are computed by Cortex)")
