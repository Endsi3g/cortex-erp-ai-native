...
const items: IncomingItem[] = [
  {
    ...
    confidence: 94,
    composerUrl: '/app/cortex-rental/new?items=DEMO-ITM-ALX35,DEMO-ITM-CKE-S4&starts_at=2026-09-12&ends_at=2026-09-19'
  },
  {
    id: 'inb-02',
    ...
    confidence: 88,
    composerUrl: '/app/cortex-rental/new?items=DEMO-ITM-VRP8K&starts_at=2026-09-20&ends_at=2026-09-23'
  }
]
</script>
