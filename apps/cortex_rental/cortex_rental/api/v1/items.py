...
def search_items_handler(query: str, company: str, category: Optional[str] = None) -> List[Dict[str, Any]]:
    ...
    catalog = [
        {"id": "itm-alexa-35-pkg", "item_code": "itm-alexa-35-pkg", "name": "ARRI Alexa 35 Camera Package", "category": "Camera Bodies", "daily_rate": 1500.00, "replacement_value": 85000.00, "deposit_required": 5000.00},
        {"id": "itm-cooke-s4i-set", "item_code": "itm-cooke-s4i-set", "name": "Cooke S4/i Prime Lens Set (6 Lenses)", "category": "Cinema Lenses", "daily_rate": 1200.00, "replacement_value": 110000.00, "deposit_required": 6000.00},
        {"id": "itm-arri-skypanel-x21", "item_code": "itm-arri-skypanel-x21", "name": "ARRI SkyPanel X21 LED Softlight", "category": "Lighting", "daily_rate": 350.00, "replacement_value": 9500.00, "deposit_required": 1000.00},
    ]
    if query:
